...
url: 'https://sap-se.zoom.com/j/94833714827'
id: ui5ers-53
start: '2025-10-09 15:15 Europe/Berlin'
end: '2025-10-09 16:00 Europe/Berlin'
```
In this episode, we'll introduce and demonstrate the brand-new UI5 MCP server. Discover how this powerful tool supercharges the development of 
freestyle OpenUI5/SAPUI5 applications by providing coding agents with direct access to essential resources like the linter, official documentation, 
and your current project's configuration. We’ll show you how it can even scaffold entire best-practice projects from scratch, saving you time and 
ensuring a solid foundation. 

Additionally, we'll clarify the best ways to instantiate components. We'll provide a comprehensive overview of the different mechanisms available in 
...
url: 'https://sap-se.zoom.com/j/94833714827'
id: ui5ers-52
start: '2025-09-11 15:15 Europe/Berlin'
end: '2025-09-11 16:00 Europe/Berlin'
```
...
url: 'https://sap-se.zoom.com/j/94833714827'
id: ui5ers-51
start: '2025-08-14 15:15 Europe/Berlin'
end: '2025-08-14 16:00 Europe/Berlin'
```
...
end: '2025-07-08 22:00 Europe/Berlin'
```
(No description)
...
url: 'https://sap-se.zoom.com/j/94833714827'
id: ui5ers-50
start: '2025-06-05 15:15 Europe/Berlin'
end: '2025-06-05 16:00 Europe/Berlin'
```
...
end: '2025-03-13 16:00 Europe/Berlin'
```
...
id: ui5ers-46
start: '2025-02-13 15:15 Europe/Berlin'
end: '2025-02-13 16:00 Europe/Berlin'
```
...
id: ui5ers-45
start: '2025-01-09 15:15 Europe/Berlin'
end: '2025-01-09 16:00 Europe/Berlin'
```
...
id: ui5ers-44
start: '2024-12-12 15:15 Europe/Berlin'
end: '2024-12-12 16:00 Europe/Berlin'
```
...
id: ui5ers-43
start: '2024-11-14 15:15 Europe/Berlin'
end: '2024-11-14 16:00 Europe/Berlin'
```
...
id: sap-devtober24-04
start: '2024-10-25 10:00 Europe/Berlin'
end: '2024-10-25 11:00 Europe/Berlin'
```
...
start: '2024-10-18 14:00 Europe/Berlin'
end: '2024-10-18 15:00 Europe/Berlin'
```
...
id: sap-devtober24-02
start: '2024-10-18 11:00 Europe/Berlin'
end: '2024-10-18 12:00 Europe/Berlin'
```
...
id: ui5ers-42
start: '2024-10-10 15:15 Europe/Berlin'
end: '2024-10-10 16:00 Europe/Berlin'
```
...
id: sap-devtober24-01
start: '2024-09-27 11:00 Europe/Berlin'
end: '2024-09-27 12:00 Europe/Berlin'
```
...
url: 'https://youtu.be/ijgPJTOIc08'
recordingUrl: 'https://youtu.be/ijgPJTOIc08'
id: sap-devtober24-05
start: '2024-09-27 10:00 Europe/Berlin'
end: '2024-09-27 10:30 Europe/Berlin'
```
...
id: ui5ers-41
start: '2024-09-12 15:15 Europe/Berlin'
end: '2024-09-12 16:00 Europe/Berlin'
```
...
id: ui5ers-40
start: '2024-08-08 15:15 Europe/Berlin'
end: '2024-08-08 16:00 Europe/Berlin'
```
...
id: ui5ers-39
start: '2024-07-11 15:15 Europe/Berlin'
end: '2024-07-11 16:00 Europe/Berlin'
```
...
end: '2024-06-05 23:00 Europe/Berlin'
```
(No description)
...
id: ui5ers-38
start: '2024-05-16 15:15 Europe/Berlin'
end: '2024-05-16 16:00 Europe/Berlin'
```
...
id: ui5ers-37
start: '2024-04-11 15:15 Europe/Berlin'
end: '2024-04-11 16:00 Europe/Berlin'
```
...
id: ui5ers-36
start: '2024-03-14 15:15 Europe/Berlin'
end: '2024-03-14 16:00 Europe/Berlin'
```
...
id: ui5ers-35
start: '2024-02-08 15:15 Europe/Berlin'
end: '2024-02-08 16:00 Europe/Berlin'
```
...
id: ui5ers-34
start: '2024-01-11 15:15 Europe/Berlin'
end: '2024-01-11 16:00 Europe/Berlin'
```
...
id: ui5ers-33
start: '2023-12-14 15:15 Europe/Berlin'
end: '2023-12-14 16:00 Europe/Berlin'
```
...
id: ui5ers-32
start: '2023-11-09 15:15 Europe/Berlin'
end: '2023-11-09 16:00 Europe/Berlin'
```
...
id: ui5ers-31
start: '2023-10-12 15:15 Europe/Berlin'
end: '2023-10-12 16:00 Europe/Berlin'
```
...
id: ui5ers-30
start: '2023-09-14 15:15 Europe/Berlin'
end: '2023-09-14 16:00 Europe/Berlin'
```
...
id: ui5ers-29
start: '2023-07-27 15:15 Europe/Berlin'
end: '2023-07-27 16:00 Europe/Berlin'
```
...
end: '2023-07-06 22:00 Europe/Berlin'
```
(No description)
...
id: ui5ers-28
start: '2023-06-15 15:15 Europe/Berlin'
end: '2023-06-15 16:00 Europe/Berlin'
```
...
id: ui5ers-27
start: '2023-05-11 15:15 Europe/Berlin'
end: '2023-05-11 16:00 Europe/Berlin'
```
...
id: ui5ers-26
start: '2023-04-13 15:15 Europe/Berlin'
end: '2023-04-13 16:00 Europe/Berlin'
```
...
id: ui5ers-25
start: '2023-03-09 15:15 Europe/Berlin'
end: '2023-03-09 16:00 Europe/Berlin'
```
...
id: ui5ers-24
start: '2023-02-09 15:15 Europe/Berlin'
end: '2023-02-09 16:00 Europe/Berlin'
```
...
id: ui5ers-23
start: '2023-01-12 15:15 Europe/Berlin'
end: '2023-01-12 16:00 Europe/Berlin'
```
...
id: ui5ers-22
start: '2022-12-08 15:15 Europe/Berlin'
end: '2022-12-08 16:00 Europe/Berlin'
```
...
id: sap-teched22-01
start: '2022-11-16 21:30 Europe/Berlin'
end: '2022-11-16 21:55 Europe/Berlin'
```
(No description)
...
id: ui5ers-21
start: '2022-11-10 15:15 Europe/Berlin'
end: '2022-11-10 16:00 Europe/Berlin'
```
...
id: sap-devtob22-03
start: '2022-10-25 09:00 Europe/Berlin'
end: '2022-10-25 09:30 Europe/Berlin'
```
...
id: sap-devtob22-02
start: '2022-10-18 17:00 Europe/Berlin'
end: '2022-10-18 17:30 Europe/Berlin'
```
...
end: '2022-10-18 10:00 Europe/Berlin'
```
...
id: ui5ers-20
start: '2022-08-11 15:15 Europe/Berlin'
end: '2022-08-11 16:00 Europe/Berlin'
```
...
id: ui5ers-19
start: '2022-07-14 15:15 Europe/Berlin'
end: '2022-07-14 16:00 Europe/Berlin'
```
...
id: ui5ers-18
start: '2022-05-12 15:15 Europe/Berlin'
end: '2022-05-12 16:00 Europe/Berlin'
```
...
id: ui5ers-17
start: '2022-04-14 15:15 Europe/Berlin'
end: '2022-04-14 16:00 Europe/Berlin'
```
...
id: ui5ers-16
start: '2022-03-10 15:15 Europe/Berlin'
end: '2022-03-10 16:00 Europe/Berlin'
```
...
id: ui5ers-15
start: '2022-02-10 15:15 Europe/Berlin'
end: '2022-02-10 16:00 Europe/Berlin'
```
...
id: vaadin-acc-web-components
start: '2022-01-20 19:00 Europe/Berlin'
end: '2022-01-20 20:00 Europe/Berlin'
```
...
id: ui5ers-14
start: '2022-01-13 15:15 Europe/Berlin'
end: '2022-01-13 16:00 Europe/Berlin'
```
...
id: sap-open-source-webinar-ui5-web-components
start: '2021-12-14 15:00 Europe/Berlin'
end: '2021-12-14 16:00 Europe/Berlin'
```
...
id: ui5ers-13
start: '2021-12-09 15:15 Europe/Berlin'
end: '2021-12-09 16:00 Europe/Berlin'
```
...
id: sap-community-call-ui5-web-components
start: '2021-11-30 15:00 Europe/Berlin'
end: '2021-11-30 16:00 Europe/Berlin'
```
...
id: ui5ers-12
start: '2021-11-11 15:15 Europe/Berlin'
end: '2021-11-11 16:00 Europe/Berlin'
```
...
id: ui5ers-11
start: '2021-10-14 15:15 Europe/Berlin'
end: '2021-10-14 16:00 Europe/Berlin'
```
...
id: ui5ers-10
start: '2021-08-12 15:15 Europe/Berlin'
end: '2021-08-12 16:00 Europe/Berlin'
```
...
id: ui5ers-09
start: '2021-07-08 15:15 Europe/Berlin'
end: '2021-07-08 16:00 Europe/Berlin'
```
...
id: ui5ers-08
start: '2021-05-20 15:15 Europe/Berlin'
end: '2021-05-20 16:00 Europe/Berlin'
```
...
id: sap-community-call-latest-development-in-ui5
start: '2021-04-14 16:00 Europe/Berlin'
end: '2021-04-14 17:00 Europe/Berlin'
```
...
id: ui5ers-07
start: '2021-04-08 15:15 Europe/Berlin'
end: '2021-04-08 16:00 Europe/Berlin'
```
...
id: ui5ers-06
start: '2021-03-11 15:15 Europe/Berlin'
end: '2021-03-11 16:00 Europe/Berlin'
```
...
id: ui5ers-05
start: '2021-02-11 15:15 Europe/Berlin'
end: '2021-02-11 16:00 Europe/Berlin'
```
...
id: sap-community-teched-ui5-tooling
start: '2021-01-28 19:00 Europe/Berlin'
end: '2021-01-28 19:25 Europe/Berlin'
```
...
id: sap-community-teched-developing-ui5-app
start: '2021-01-26 10:00 Europe/Berlin'
end: '2021-01-26 12:00 Europe/Berlin'
```
...
id: ui5ers-04
start: '2021-01-14 15:15 Europe/Berlin'
end: '2021-01-14 16:00 Europe/Berlin'
```
...
id: ui5ers-03
start: '2020-12-10 15:15 Europe/Berlin'
end: '2020-12-10 16:00 Europe/Berlin'
```
...
id: ui5ers-02
start: '2020-11-12 15:15 Europe/Berlin'
end: '2020-11-12 16:00 Europe/Berlin'
```
...
id: ui5ers-01
start: '2020-10-15 15:15 Europe/Berlin'
end: '2020-10-15 16:00 Europe/Berlin'
```
...
end: '2020-07-10 13:30 Europe/Berlin'
```
(No description)
...
id: sap-community-call-ui5-tooling
start: '2020-04-01 16:00 Europe/Berlin'
end: '2020-04-01 17:00 Europe/Berlin'
```
...
end: '2020-02-14 16:30 Europe/Berlin'
```
(No description)
