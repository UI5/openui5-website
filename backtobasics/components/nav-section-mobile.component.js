...
Vue.component("nav-section-mobile", {
  ...
  template:`<div class="mobile-nav">
    ...
    <ul class="mobile-nav-menu" v-if="hamburgerMenuVisible">
        <li>
            <a href="documentation.html" :class="{ active: isActive('documentation') }" :aria-current="isActive('documentation')">Documentation</a>
        </li>
        <li>
            <a href="releases.html" :class="{ active: isActive('releases') }" :aria-current="isActive('releases')">Releases</a>
        </li>
        <li>
            <a href="events.html" :class="{ active: isActive('events') }" :aria-current="isActive('events')">Events</a>
        </li>
        <li>
            <a href="community.html" :class="{ active: isActive('community') }" :aria-current="isActive('community')">Community</a>
        </li>
        <li>
